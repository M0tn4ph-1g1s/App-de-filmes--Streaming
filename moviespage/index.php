...
<head>
	...
	<title>Cine New Genereation</title>
...
<body class="body">
						...
						<div class="header__content">
							...
							<ul class="header__nav">
								...
								<li class="header__nav-item">
									...
									<a class="dropdown-menu header__dropdown-menu" aria-labelledby="dropdownMenuCatalog">
				...
				<div class="row">
					<div class="col-12">
						<div class="header__search-content">
							<input type="text" placeholder="procure pelo filme ou serie que deseje assistir ">
	...
	<section class="home">
		...
		<div class="container">
			<div class="row">
				<div class="col-12">
					<h1 class="home__title"><b>Novos Items</b> Da temporada</h1>
